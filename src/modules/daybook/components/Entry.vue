<template>
    <div class="entry-container mb-3 pointer p-2" @click="$router.push({ name: 'entry', params: { id: 10 } })">
        ...
        <div class="entry-description">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum porro culpa ab odio cum quam nostrum eius nisi illum? Explicabo quo placeat assumenda! Sapiente sunt pariatur nihil odit fugit aut.
        </div>
    </div>
</template>
