<template>
  <div class="entry-title d-flex justify-content-between p-2">
      ...
      <div>
        <button class="btn btn-danger mx-2">Borrar <i class="fas fa-trash-alt"></i></button>
        <button class="btn btn-primary mx-2">Subir Foto <i class="fas fa-upload"></i></button>
      </div>
  </div>
  ...
  <div class="d-flex flex-column px-3 h-75">
    <textarea class="form-control" placeholder="¿Qué sucedió hoy?"></textarea>
  </div>
