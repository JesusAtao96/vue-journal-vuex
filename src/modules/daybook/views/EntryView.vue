  ...
  <template v-if="entry">
    <div class="entry-title d-flex justify-content-between p-2">
        ...
        <div>
          ...
          <button v-if="entry.id" class="btn btn-danger mx-2" @click="onDeleteEntry">Borrar <i class="fas fa-trash-alt"></i></button>
          <button class="btn btn-primary mx-2" @click="onSelectImage">Subir Foto <i class="fas fa-upload"></i></button>
        </div>
    </div>
